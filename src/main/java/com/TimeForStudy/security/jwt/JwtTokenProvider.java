...
import com.TimeForStudy.security.JwtUserDetailsService;
...
public class JwtTokenProvider {
    ...
    public String createToken(String phone, UserRole role) {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new ApplicationException(ErrorDescription.ACCESS_FORBIDDEN);
        }
    }
